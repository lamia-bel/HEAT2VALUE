...
def calcul_kpi(df_sim, df_decision):
    ...
    decision = df_decision["decision"].to_numpy()
...
if __name__ == "__main__":
    ...
    print(f"CUE moyen : {df_kpi['CUE_gCO2/kWh'].mean():.3f} gCO2/kWh")
    print(f"WUE moyen : {df_kpi['WUE_L/kWh'].mean():.3f} L/kWh")