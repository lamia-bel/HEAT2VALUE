...
if __name__ == "__main__":
    ...
    print(f"\nChaleur moyenne produite : {df['chaleur_produite_kW'].mean():.0f} kW")
    print(f"\nTempérature moyenne extérieure : {df['temp_exterieure_C'].mean():.1f} °C")
    print(f"\nIntensité carbone moyenne : {df['intensite_carbone_gCO2/kWh'].mean():.0f} gCO2/kWh")